...
then
  ...
  ./ci/deploy_files.sh 96.118.153.235 logs.tgz;
  checkError $? "Unable to send log files to 96.118.153.235" "Possible reason - Server could be down" "Retry"
fi
...
then
  ...
  ./ci/release_osx.sh 96.118.153.235 release.tgz 
  checkError $? "unable to send artifacts to 96.118.153.235" "96.118.153.235 down?" "Retry"
fi
